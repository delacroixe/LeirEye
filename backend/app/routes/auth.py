...
async def change_password(
    ...
    return MessageResponse(message="Contraseña actualizada correctamente", success=True)
...
async def logout(current_user: User = Depends(get_current_user)):
    ...
    """
    return MessageResponse(message="Sesión cerrada correctamente", success=True)
...
async def verify_access_token(current_user: User = Depends(get_current_user)):
    ...
    """
    return MessageResponse(message="Token válido", success=True)
